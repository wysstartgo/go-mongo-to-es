...
func (c *Client) DoWithBytes(method string,url string,bodyData []byte) (*Response,error) {
...
func (c *Client) CreateMappingByFile(index string,docType string,mappingData []byte) error{
	...
	_, err := c.DoWithBytes("PUT", reqURL, mappingData)
	return errors.Trace(err)
}
